 ...
 * @author Roger Howell
 */
public class ReflectionTypePatternDeclaration implements ResolvedTypePatternDeclaration {
     ...
     */
    public ReflectionTypePatternDeclaration(Class<?> type, TypeSolver typeSolver, String name) {
        this.type = type;
