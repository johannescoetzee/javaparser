...
class JavassistModuleTest extends AbstractSymbolResolutionTest {
    ...
    void shouldResolveExportedTypeInModule() {
        SymbolReference<ResolvedReferenceTypeDeclaration> solved = typeSolver.tryToSolveTypeInModule("com.github.javaparser.testmodule", "TestClass");
        assertTrue(solved.isSolved());
        assertEquals("com.github.javaparser.testpackage.TestClass", solved.getCorrespondingDeclaration().getQualifiedName());
    }
}
